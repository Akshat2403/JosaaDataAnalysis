...
BRANCHES = [
    ("Biotechnology and Biochemical Engineering (4 Years Bachelor of Technology)", "Bio Technology"),
    ("Chemical Engineering (4 Years Bachelor of Technology)", "Chemical Engineering"),
    ("Chemical Science and Technology (4 Years Bachelor of Technology)", "Chemical Science and Technology"),
    ("Civil Engineering (4 Years Bachelor of Technology)", "Civil Engineering"),
    ("Computer Science and Engineering (4 Years Bachelor of Technology)", "Computer Science and Engineering"),
    ("Electronics and Communication Engineering (4 Years Bachelor of Technology)", "Electronics and Communication Engineering"),
    ("Electronics and Electrical Engineering (4 Years Bachelor of Technology)", "Electronics and Electrical Engineering"),
    ("Engineering Physics (4 Years Bachelor of Technology)", "Engineering Physics"),
    ("Mathematics and Computing (4 Years Bachelor of Technology)", "Mathematics and Computing"),
    ("Mechanical Engineering (4 Years Bachelor of Technology)", "Mechanical Engineering"),
    ("Biosciences and Bioengineering (4 Years Bachelor of Technology)", "Biosciences and Bioengineering"),
    ("Data Science and Artificial Intelligence (4 Years Bachelor of Technology)", "Data Science and Artificial Intelligence"),
    ("Energy Engineering (4 Years Bachelor of Technology)", "Energy Engineering")
]
SEAT_TYPES = [
    ('OPEN',"OPEN"),
    ('OBC-NCL',"OBC-NCL"),
